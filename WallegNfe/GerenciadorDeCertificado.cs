...
namespace WallegNFe
{
    ...
    public class GerenciadorDeCertificado : IGerenciadorDeCertificado
    {
        ...
        {
            X509Certificate2Collection scollection = X509Certificate2UI.SelectFromCollection(ListaCertificados(), "Certificado(s) Digital(is) disponível(is)", "Selecione o certificado digital para uso no aplicativo", X509SelectionFlag.SingleSelection);
        ...
        {
            X509Certificate2Collection colecao = ListaCertificados();
